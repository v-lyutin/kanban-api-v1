...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    protected void init() {
        ...
        task3 = new Task("Task 3", "Task 3 description", "2024.09.29, 10:00", 120);
        task4 = new Task("Task 4", "Task 4 description", "2024.09.09, 15:30", 120);
        task5 = new Task("Task 5", "Task 5 description", "2024.09.08, 18:00", 30);
